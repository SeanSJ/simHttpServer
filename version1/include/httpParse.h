...
namespace http{
		...
		public: 
				...
				static HTTP_CODE parse_content(char *buffer, int &check_index, int &read_index, PARSE_STATE & parse_state, int &start_line, HttpRequest & request);
		...
		public:
				...
				std::string mUrl;
				char *mContent;
				std::unordered_map<HTTP_HEADER, std::string, EnumClassHash> mHeader;
